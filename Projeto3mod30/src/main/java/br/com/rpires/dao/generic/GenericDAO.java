...
import main.java.br.com.rpires.exceptions.*;
...
public abstract class GenericDAO<T extends Persistente, E extends Serializable> implements IGenericDAO<T, E> {
        ...
        try {
            ...
            if (rs.next()) {
                    ...
                    if (field.isAnnotationPresent(ColunaTabela.class)) {
                        ...
                        try {
                            ...
                            setValueByType(entity, method, classField, rs, dbName);
                                 ...
                                 InvocationTargetException | TipoElementoNaoConhecidoException e) {
                ...
                return entity;
                 ...
                 SecurityException | TipoChaveNaoEncontradaException e) {
            throw new DAOException("ERRO CONSULTANDO OBJETO ", e);
        }
        return null;
    }
    ...
    private void setValueByType(T entity, Method method, Class<?> classField, ResultSet rs, String fieldName) throws SQLException, InvocationTargetException, IllegalAccessException {
    ...
    private Object getValueByType(Class<?> typeField, ResultSet rs, String fieldName) throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                list.add(entity);
                 ...
                 IllegalArgumentException | InvocationTargetException | NoSuchMethodException |
                 SecurityException | TableException e) {
            throw new DAOException("ERRO LISTANDO OBJETOS ", e);
        } finally {
            closeConnection(connection, stm, rs);
        }
