...
import main.java.br.com.rpires.dao.factory.ProdutoQuantidadeFactory;
import main.java.br.com.rpires.dao.factory.VendaFactory;
...
//		return venda;
	...
	private StringBuilder sqlBaseSelect() {
		...
		sb.append("C.ID AS ID_CLIENTE, C.NOME, C.CPF, C.TEL, C.ENDERECO, C.NUMERO, C.CIDADE, C" +
				".ESTADO,C.PAIS ");
	...
	@Override
	public Boolean cadastrar(Venda entity){
		Connection connection = null;
    	PreparedStatement stm = null;
    	try {
    		connection = getConnection();
